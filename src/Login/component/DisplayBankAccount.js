...
const DisplayBankAccount = (props) => {
    ...
    return (
        <>
            <p style={{ fontSize: "20px", fontWeight: "500" }}>Bank Account for Your Office</p>
            <div className='box-onboarding-text' style={{ padding: "30px 15px" }}>
            ...
            <Button onClick={handleNext} className='login-button mt25'>
                Next
            </Button>
