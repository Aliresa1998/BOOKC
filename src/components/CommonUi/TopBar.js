  ...
  const menu = hasMenu ? (
    <div>
      ...
      <div className="seperator commonui_mt10">
        ...
        <img alt="logo" src={officeLogo?officeLogo:Logo}
          style={
            windowDimensions ?
              windowDimensions.width > "700" ?
                { maxWidth: "140px", maxHeight: "45px" }
                :
                windowDimensions.width > "450" ?
                  { maxWidth: "120px", maxHeight: "30px",marginLeft:'30px' }

                  :
                  { maxWidth: "00px", maxHeight: "22px" ,marginLeft:'30px' }
              :
              {}
        ...
        <ul className="menu logged-in">
          ...
          <li>
            <NavLink to="/" onClick={async () => {
              ...
              <LogoutOutlined  style={windowDimensions ?
                windowDimensions.width > "700" ?
                  { fontSize: '20px', color: '#7A08FA' }
                  :
                  windowDimensions.width > "450" ?
