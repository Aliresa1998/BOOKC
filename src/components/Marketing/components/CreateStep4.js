...
const CampaignInfo = (props) => {
    ...
    const handleReadCampaigns = async () => {
        try {
            const response = await controller.getCampaignsInfo(0, 99);
        ...
        <>
            ...
            <div style={{ marginTop: 20 }}>
                ...
                <div style={{ width: '100%', marginTop: 10 }}>
                    ...
                    <Link href="#" style={{ fontSize: '16px', marginLeft: '88.8%' }}>1234 Patients</Link>
                </div>
            </div>
            ...
            <div className="email-template-container">
                <div className="campaign-details">
                    <div className="detail-item">
                        ...
                        <Tag  style={{ height: 28, background: '#EEEDFA', borderRadius: '500px', color: '#6B43B5', padding: 3, paddingLeft: 8, paddingRight: 8, marginTop: 20 }}>Location : Houston</Tag>
                    </div>
                    <div className="detail-item">
